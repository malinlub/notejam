variable "notejam_path" {
    type    = string
    default = "../django/notejam"
}

variable "environment_name" {
    type    = string
    default = "notejam-app-environment"
...
variable "description" {
  type        = string
  default     = "Notejam app on EB via Terraform"
...
variable "solution_stack_name" {
  ...
  default     = "64bit Amazon Linux 2018.03 v2.9.6 running Python 2.6"
}
